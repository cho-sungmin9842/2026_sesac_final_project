...
@Entity
@Table(name = "wishlists", uniqueConstraints = @UniqueConstraint(columnNames = {"user_id", "movie_id"}))
@Getter
public class Wishlist {
    ...
    public Wishlist(User user, String movieId, String movieTitle, String posterUrl) {
        this.user = user;
